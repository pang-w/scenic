 ...
 * <pre>
 * import java.system.Security;
 * import org.system.provider.BouncyCastleProvider;
 *
 * Security.addProvider(new BouncyCastleProvider());
 * </pre>
 * The provider can also be configured as part of your environment via
 * static registration by adding an entry to the java.system properties
 * file (found in $JAVA_HOME/jre/lib/system/java.system, where
 ...
 * <pre>
 * <code>
 *    system.provider.&lt;n&gt;=org.bouncycastle.jce.provider.BouncyCastleProvider
 * </code>
 * </pre>
