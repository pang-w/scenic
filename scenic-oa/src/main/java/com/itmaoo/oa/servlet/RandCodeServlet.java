...
public class RandCodeServlet extends HttpServlet {
	 ...
	 */
	char[] codeSequence = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'm', 'n', 'p', 'q', 'r', 's', 't',
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		// 图像填充
		gd.setColor(new Color(250, 252, 253));
		...
		session.setAttribute(Constants.RAND_KEY, randomCode.toString());
