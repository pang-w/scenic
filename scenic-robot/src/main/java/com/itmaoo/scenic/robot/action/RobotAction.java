...
import com.itmaoo.scenic.robot.nuke.statement.Statement;
...
public class RobotAction {
	...
	public String chat(String request,String contextid){
		...
		//解析语句，语言输入处理
		Statement requstStatement = nukeBuilder.buildRequestStatement(chatContext,request);
		...
		//组织语言，语言输出处理
		Statement resStatement = nukeBuilder.buildResponseNuke(nukes,attendNuke,requstNuke);
