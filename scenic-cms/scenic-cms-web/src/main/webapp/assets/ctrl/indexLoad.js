...
function loadIndexAll() {
	...
	app.controller('iukissCtrl', function($scope, $http) {
		...
		$http.post("/action/page/index/all", {}).then(function(result) {
		...
		$scope.searchArticlePrevious = function() {
			...
			support.ajax("page/index/article", {
		...
		$scope.ngEditProduct = function(pid) {
			support.ajax("user/auth/checkLogged", null, function(response) {
